...
def _chat_runtime_options() -> dict:
    """Параметры Ollama /api/chat options (контекст и опционально температура)."""
    opts: dict[str, float | int] = {"num_ctx": settings.ollama_num_ctx}
