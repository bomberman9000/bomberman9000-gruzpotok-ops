# Continue optimization from where it stopped
...
Write-Host "  Continuing Windows Optimization" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if (-not ($Performance -or $Security -or $Beauty -or $All)) {
    Write-Host "Usage:" -ForegroundColor Yellow
    Write-Host "  .\continue-optimization.ps1 -All              # Continue all remaining steps" -ForegroundColor White
    Write-Host "  .\continue-optimization.ps1 -Performance      # Performance only" -ForegroundColor White
    Write-Host "  .\continue-optimization.ps1 -Security         # Security only" -ForegroundColor White
    Write-Host "  .\continue-optimization.ps1 -Beauty           # Beauty only" -ForegroundColor White
    exit 0
}
