...
# Method 1: Reset Store
Write-Host "[1/5] Resetting Store app..." -ForegroundColor Yellow
try {
...
# Method 2: Remove Registry restrictions
Write-Host ""
Write-Host "[2/5] Removing Registry restrictions..." -ForegroundColor Yellow
...
# Method 3: Enable services
Write-Host ""
Write-Host "[3/5] Enabling services..." -ForegroundColor Yellow
...
# Method 4: Reset cache
Write-Host ""
Write-Host "[4/5] Resetting cache..." -ForegroundColor Yellow
try {
...
# Method 5: Re-register Store
Write-Host ""
Write-Host "[5/5] Re-registering Store..." -ForegroundColor Yellow
try {
...
Write-Host ""
Write-Host "After restart, try opening Microsoft Store." -ForegroundColor White
Write-Host ""
